namespace Abstrata
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Por favor, preencha o nome do fornecedor.");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show($"Último cliente cadastrado: {ultimoCliente.nome}");
            }
            else if (ultimoFornecedor != null)
            {
                MessageBox.Show($"Último fornecedor cadastrado: {ultimoFornecedor.nome}");
            }
            else
            {
                MessageBox.Show("Nenhum item foi cadastrado.");
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nenhum cliente foi cadastrado para realizar a venda.");
            }
        }
    }
}
