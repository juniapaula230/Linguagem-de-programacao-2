...
namespace Empresa {
    ...
    public partial class EmpresaDataSet : global::System.Data.DataSet {
        ...
        public partial class funcionarioDataTable : global::System.Data.TypedTableBase<funcionarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public funcionarioRow AddfuncionarioRow(string Nome, string CPF, string Telefone, decimal Salario) {
    ...
    public partial class funcionarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[funcionario] WHERE (([Id] = @Original_Id) AND ([Nome] = @Origi" +
                "nal_Nome) AND ([CPF] = @Original_CPF) AND ([Telefone] = @Original_Telefone) AND " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[funcionario] ([Nome], [CPF], [Telefone], [Salario]) VALUES (@N" +
                "ome, @CPF, @Telefone, @Salario);\r\nSELECT Id, Nome, CPF, Telefone, Salario FROM f" +
                "uncionario WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[funcionario] SET [Nome] = @Nome, [CPF] = @CPF, [Telefone] = @Telefone, [Salario] = @Salario WHERE (([Id] = @Original_Id) AND ([Nome] = @Original_Nome) AND ([CPF] = @Original_CPF) AND ([Telefone] = @Original_Telefone) AND ((@IsNull_Salario = 1 AND [Salario] IS NULL) OR ([Salario] = @Original_Salario)));
SELECT Id, Nome, CPF, Telefone, Salario FROM funcionario WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Empresa.Properties.Settings.Default.EmpresaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nome, CPF, Telefone, Salario FROM dbo.funcionario";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Id, Nome, CPF, Telefone, Salario\r\nFROM            funcionario\r\nWHER" +
                "E        (Nome LIKE @Nome + \'%\'); \r\n";
        ...
        public virtual int FillByBuscaNome(EmpresaDataSet.funcionarioDataTable dataTable, string Nome) {
        ...
        public virtual EmpresaDataSet.funcionarioDataTable GetDataByNome(string Nome) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
        ...
        public virtual int Delete(int Original_Id, string Original_Nome, string Original_CPF, string Original_Telefone, global::System.Nullable<decimal> Original_Salario) {
        ...
        public virtual int Insert(string Nome, string CPF, string Telefone, global::System.Nullable<decimal> Salario) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
        ...
        public virtual int Update(string Nome, string CPF, string Telefone, global::System.Nullable<decimal> Salario, int Original_Id, string Original_Nome, string Original_CPF, string Original_Telefone, global::System.Nullable<decimal> Original_Salario, int Id) {
            if ((Nome == null)) {
                throw new global::System.ArgumentNullException("Nome");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string CPF, string Telefone, global::System.Nullable<decimal> Salario, int Original_Id, string Original_Nome, string Original_CPF, string Original_Telefone, global::System.Nullable<decimal> Original_Salario) {
            return this.Update(Nome, CPF, Telefone, Salario, Original_Id, Original_Nome, Original_CPF, Original_Telefone, Original_Salario, Original_Id);
        }
    }
